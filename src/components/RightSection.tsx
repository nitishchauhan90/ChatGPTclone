...
const RightSection = () => {
    ...
    const sendMessage = async ()=>{
        ...
        let token = `Bearer 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`
    ...
    <div className={styles.rightSection}>
        ...
        <div className={styles.nochat}>
            <div className={styles.s1}>
                <Image src={chatgptlogo} alt='chatGPT' width={70} height={70}/>
        ...
        <div className={styles.bottomsection}>
            <div className={styles.messagebar}>
                <input type='text' placeholder='Message ChatGPT...' onChange={(e)=>setMessage(e.target.value)} value={message}></input>
                <svg 
                    onClick={sendMessage}

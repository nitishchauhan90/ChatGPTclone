  ...
  return (
    <div className={styles.leftSection}>
        <div className={styles.newChat}>
            <div>
                <Image src={chatgptlogo} alt='ChatGPT' height={50} width={50}></Image>
        ...
        <div className={styles.newChat}>
            <div>
                <Image src={nouserlogo} alt="ChatGPT" width={60} height={60}></Image>
                <p className={styles.text1}>Nitish chauhan</p> 
            </div>
        </div>
    </div>
  )
